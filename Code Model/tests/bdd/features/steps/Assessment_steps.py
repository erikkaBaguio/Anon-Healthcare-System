...
def then_the_nurse_should_get_a_group1_response(step, expected_status_code):
    assert_equals(world.assessment_post_response.status_code, int(expected_status_code))
