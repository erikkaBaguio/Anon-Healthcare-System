...
# @step(u'Given diseases that are already stored in the system')
# def given_diseases_that_are_already_stored_in_the_system(step):
#     DISEASES.update({'done': 'True', 'id': '1', 'name': 'dengue'})

# @step(u'When the admin retrieve the disease with an id number \'([^\']*)\'')
